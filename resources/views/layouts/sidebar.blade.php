            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               <li class="nav-item">
                ...
                <li class="nav-item {{ (Request::is('user*')||Request::is('show*')) ? 'menu-open' : '' }}">
                  ...
                  <a href="#" class="nav-link {{ (Route::is('user.index') || Route::is('create.user')||Request::is('show*')) ? 'active bg-dark' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                      <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/>
                    </svg>
                    <p style="margin-left: 10px;">
                ...
                {{-- tag --}}
                  <li class="nav-item {{ (Request::is('tag*')) ? 'menu-open' : '' }}">
                    ...
                    <a href="#" class="nav-link {{ (Route::is('tag.index') || Route::is('tag.create') || Route::is('tag.edit')) ? 'active bg-dark' : '' }}">
                ...
                <li class="nav-item {{ (Request::is('category*')) ? 'menu-open' : '' }}">
                    ...
                    <a href="#" class="nav-link {{ (Route::is('catego.index') || Route::is('catego.create') || Route::is('catego.edit')) ? 'active bg-dark' : '' }}">
                    ...
                    <li class="nav-item {{ (Request::is('post*')) ? 'menu-open' : '' }}">
                      ...
                      <a href="#" class="nav-link {{ (Route::is('post.index') || Route::is('post.create') || Route::is('post.edit')) ? 'active bg-dark' : '' }}">
                      ...
                      <li class="nav-item">
                        <a href="{{ route('post-saves.show',['post' => auth()->user()->id ]) }}" class="nav-link {{ Route::is('post-saves.show') ? 'active bg-dark' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
                                <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5Z"/>
                              </svg>
                            <p style="margin-left: 10px;">
